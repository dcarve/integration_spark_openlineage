...
builder = (
    SparkSession.builder.appName(f's-parquetinputoutput-{taskname}')
...
df = spark.read.parquet('examples/data/inputs/parque_example')

df.write.mode('overwrite').parquet('examples/data/outputs/parque_input_output')
